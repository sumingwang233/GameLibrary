...
| 文件 | 用途 |
|---|---|
| [GameLibrary-Setup-v1.5.3.exe](https://github.com/sumingwang233/GameLibrary/releases/download/v1.5.3/GameLibrary-Setup-v1.5.3.exe) | 推荐普通用户使用的图形安装程序，可修改安装位置，并登记到 Windows“已安装的应用”。 |
| [GameLibrary-Portable-win-x64-v1.5.3.zip](https://github.com/sumingwang233/GameLibrary/releases/download/v1.5.3/GameLibrary-Portable-win-x64-v1.5.3.zip) | 免安装 Tauri 桌面版、bridge 与 Host，解压后保持三个 EXE 位于同一目录。 |
| [GameLibrary-Tools-win-x64-v1.5.3.zip](https://github.com/sumingwang233/GameLibrary/releases/download/v1.5.3/GameLibrary-Tools-win-x64-v1.5.3.zip) | 面向自动化和集成的 Host、CLI 与 MCP 工具包。 |
| [SHA-256 校验值](https://github.com/sumingwang233/GameLibrary/releases/download/v1.5.3/GameLibrary-v1.5.3-SHA256SUMS.txt) | 三个发布包的完整性校验。 |

> [!IMPORTANT]
> v1.5.3 的 Windows 程序未签名。Windows SmartScreen 可能提示未知发布者。请从本仓库 Release 下载，并核对 SHA-256。
